Given a algorithms.staircase with a number of degrees n, write a function which takes the integer n and returns the number of ways you can go from the bottom to the top.
